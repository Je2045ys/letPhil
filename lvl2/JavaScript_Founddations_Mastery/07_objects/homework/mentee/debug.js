...
// What's wrong ↓
// uppercase used when declaring the object
...
// Bug 1 ↓
// out of scope when we use <= instead of < because the indexes start at 0

// Bug 2 ↓
//  when calculating totalValue we products.stock instead of products[i].stock
