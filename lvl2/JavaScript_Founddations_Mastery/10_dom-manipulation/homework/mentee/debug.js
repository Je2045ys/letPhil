...
// What's wrong ↓
// we used the dot which tells js to look for a class but it is an id, so we change it to #
...
// What's wrong ↓
// list.innerHTML = li.outerHTML. we can just append li to list
...
// Bug 1 ↓
// <= was used instead of <; so out of bounds

// Bug 2 ↓
// adding .highlighted to the badge instead of cardcontainer
...
function highlightTasks() {
  ...
  for (let i = 0; i < highCards.length; i++) {
   const cardContainer = highBadges[i].parentElement;
