...
const fullName = "Jessy Vyiyingoma"; //the name won't change
let age = 24; //my age changes every year
let city = "Ottawa, ON"; // the city can change as well
let isStudent = true; // my student status can change
...
// fullName = "Irving"; //Uncaught TypeError: Assignment to constant variable.
...
// productName = "ABC";
console.log(productName); //productName is a constant variable
...
// i cannot reassign the value of currentYear because it is a constant variable
// to be able to change currentYear, should've use let instead of const