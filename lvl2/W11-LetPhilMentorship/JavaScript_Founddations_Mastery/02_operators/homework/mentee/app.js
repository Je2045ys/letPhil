...
const gameName = "Space Blaster"; // the name of the game is not going to change so constant variable
const playerName = "Jessy"; // the name of the player is not going to change
let playerScore = 0; // the score increases
let highScore = 850; // the highscore can change
const pointsPerKill = 25; // the points per kill remain the same
let livesRemaining = 3; // this variable can change
...
console.log(livesRemaining > 0) // true; it means the player has not lost his life yet because he still have at least 1 remaining life.
...
console.log(`Did the player beat the original high score?: ${endScore > highScore}`);
...
console.log(`${playerName} accuracy is ${accuracyPercent}%`);
